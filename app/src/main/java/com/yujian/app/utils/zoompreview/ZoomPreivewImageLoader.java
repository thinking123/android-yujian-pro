...
public class ZoomPreivewImageLoader implements IZoomMediaLoader {
...
//                .priority(Priority.HIGH);
        ...
        Glide.with(context).asBitmap()  .apply(options).load(path)
...
//                .placeholder(R.drawable.default_avatar)
        ...
        Glide.with(context)   .asGif().load(path).apply(options)
